...
import type { Property, Conversation, Message, Notification } from './types';
...
export const MOCK_PROPERTIES: Property[] = [
  ...
  },
  {
    ...
    status: 'Available',
    landlordName: 'Thoko Moyo'
  },
];

export const MOCK_CONVERSATIONS: Conversation[] = [
    { id: 1, name: 'Landlord - John Phiri', lastMessage: 'Yes, viewing is possible tomorrow at 10 AM.', avatarUrl: 'https://picsum.photos/seed/avatar1/100' },
    { id: 2, name: 'Agent - Properties Inc.', lastMessage: 'The contract is ready for signing.', avatarUrl: 'https://picsum.photos/seed/avatar2/100' },
];

export const MOCK_MESSAGES: Message[] = [
    { id: 1, sender: 'other', text: 'Hello, is this property still available?', timestamp: '10:00 AM' },
    { id: 2, sender: 'me', text: 'Hi, yes it is. Are you interested in a viewing?', timestamp: '10:01 AM' },
    { id: 3, sender: 'other', text: 'Yes, viewing is possible tomorrow at 10 AM.', timestamp: '10:05 AM' },
];

export const MOCK_NOTIFICATIONS: Notification[] = [
    { id: 1, title: 'New Message', body: 'You have a new message from John Phiri.', timestamp: '2 hours ago' },
    { id: 2, title: 'Rent Reminder', body: 'Your rent for "3 Bedroom in Area 49" is due in 3 days.', timestamp: '1 day ago' },
    { id: 3, title: 'New Listing Alert', body: 'A new 2 bedroom property is available in Lilongwe.', timestamp: '3 days ago' },
];

export const NyumbaNowLogo = (props: React.SVGProps<SVGSVGElement>) => (
