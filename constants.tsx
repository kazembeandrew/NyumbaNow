...
import type { Listing, Conversation, Message, Notification, Review } from './types';
...
export const DropletsIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M7 16.3c2.2 0 4-1.8 4-4 0-3.3-4-6-4-6s-4 2.7-4 6c0 2.2 1.8 4 4 4z"></path>
    <path d="M17 16.3c2.2 0 4-1.8 4-4 0-3.3-4-6-4-6s-4 2.7-4 6c0 2.2 1.8 4 4 4z"></path>
  </svg>
);
...
export const BedIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M2 4v16h20V4a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2z"></path>
...
export const BathIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M21 8c0-2.2-1.8-4-4-4H7a4 4 0 0 0-4 4v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8z"></path>
  </svg>
);
...
export const MOCK_NOTIFICATIONS: Notification[] = [
    { id: 1, title: 'Welcome!', body: 'Thank you for joining NyumbaNow.', timestamp: 'Just now' }
];
